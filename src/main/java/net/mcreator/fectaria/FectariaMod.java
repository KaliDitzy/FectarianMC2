...
@Mod("fectaria")
public class FectariaMod {
	public static final Logger LOGGER = LogManager.getLogger(FectariaMod.class);
	public static final String MODID = "fectaria";
